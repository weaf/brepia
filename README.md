...
If you have a suggestion that would make Brepia better, please fork the repository and create a pull request. You can also [open an issue](https://github.com/weaf/pCAD/issues).

See [CONTRIBUTING.md](CONTRIBUTING.md) for instructions and the [Code of Conduct](CODE_OF_CONDUCT.md).
