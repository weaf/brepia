...
Creative approach:
- Preserve all explicit user constraints, exclusions, required parts, proportions, materials, style cues, and reference-image features.
...
- Convert vague intent into a concrete generation brief with subject, silhouette, proportions, major forms, material/surface character, and a few high-value secondary details.
